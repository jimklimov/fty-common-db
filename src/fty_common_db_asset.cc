...
fty_common_db_asset_t *
fty_common_db_asset_new (void)
{
    fty_common_db_asset_t *self = (fty_common_db_asset_t *) malloc (sizeof (fty_common_db_asset_t));
    assert (self);
...
fty_common_db_asset_destroy (fty_common_db_asset_t **self_p)
{
    assert (self_p);
    if (*self_p) {
        fty_common_db_asset_t *self = *self_p;
...
fty_common_db_asset_test (bool verbose)
{
    ...
    fty_common_db_asset_t *self = fty_common_db_asset_new ();
    assert (self);
    fty_common_db_asset_destroy (&self);
    //  @end
    printf ("OK\n");
}
